      ...
      {!isOpen ? (
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-3 rounded-2xl bg-amber-500 text-paper-950 hover:bg-amber-400 font-mono font-bold transition-all duration-300 shadow-2xl shadow-amber-500/30 cursor-pointer border border-amber-400 hover:scale-105 group"
            title="Buka Penjelajah Hardware Motherboard 3D Interaktif"
          >
            <Sparkles className="w-4 h-4 text-paper-950 animate-bounce" />
            <span className="text-xs tracking-wider uppercase">3D Spec Mobo</span>
          </button>

          <button
            onClick={() => setIsOpen(true)}
            className="flex items-center gap-2.5 px-4 py-3 rounded-2xl bg-paper-900/95 border border-amber-500/40 text-amber-400 hover:text-paper-950 hover:bg-amber-400 hover:border-amber-400 transition-all duration-300 shadow-2xl shadow-amber-500/20 backdrop-blur-xl group cursor-pointer"
            title="Buka Live Terminal & System Monitor UPT"
          >
            <Terminal className="w-4 h-4 animate-pulse" />
            <span className="text-xs font-bold tracking-wider uppercase">Live Terminal</span>
        ...
        <div className={`w-80 sm:w-[450px] bg-paper-950/95 border border-paper-700 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-2xl transition-all duration-300 ${isMinimized ? 'h-12' : 'h-[380px] flex flex-col'
          }`}>
          {/* Terminal Header */}
