import { Monitor, Wrench, FileText, PhoneCall, HelpCircle, Camera } from 'lucide-react';
...
export const searchItems = [
  ...
  { title: 'UPT Dump & Moment BTS', category: 'Galeri', icon: Camera, href: '#dump', desc: 'Foto candid, behind-the-scenes, dan aktivitas harian di UPT Komputer IWIMA' },
